...
*/
        ...
        class AnimationHandler {
            ...
            _layoutObserverCallback(event) {
                for (const {addedNodes} of event) for (const node of addedNodes) if (node.tagName === "svg") node.dataset.animationId = this._currentAnimationIndex;
            }
            _loadAnimation(path) {
            ...
            nextAnimation() {
                ...
                if (!this._animationCache.has(this._meta[this._currentAnimationIndex].src)) this._loadAnimation(this._meta[this._currentAnimationIndex].src).then((animation => {
        ...
        async function initLottie() {
            if (window.innerWidth > 767.98) {
                ...
                let animationHandler = new AnimationHandler(document.getElementById("animation-layout"), returnAnimationFiles());
