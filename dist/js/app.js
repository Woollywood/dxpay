        ...
        function loadAnimation(path, container) {
            return new Promise(((resolve, reject) => {
                ...
                animation.addEventListener("complete", (e => {
                    if (!isStartAnimated) bodyLockToggle();
                }));
                animation.addEventListener("DOMLoaded", (() => {
                    resolve(animation);
                }));
            ...
            if (window.innerWidth > 767.98) {
                ...
                ScrollTrigger_ScrollTrigger.create({
                    ...
                    onUpdate: triggerEvent => {
                        if (animation) {
                            let progress = triggerEvent.progress * animationFrames + START_OFFSET - triggerEvent.progress * START_OFFSET;
                            if (progress >= END_OFFSET) progress = END_OFFSET;
